...
video = VideoContainer(videoPath="badapple.mp4", width=terminal_size.columns//scaleFactor, height=round((terminal_size.lines * 2) // scaleFactor) - 2, pxScaleFactor=scaleFactor)
